      ...
      <div className="tt-container tt-container-padding">
        <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-4">
          ...
          <div className="bg-[var(--tt-surface-2)] shadow p-6 relative overflow-hidden">
            ...
            <p className="opacity-70 text-xs leading-[1.6] mb-2 sm:mb-5">
              Add a countdown clock to your listing. Watch buyers rush to book before time runs out.
              Free to start — no upfront fees.
            </p>
            <div className="flex gap-[0.6rem] flex-wrap text-white">
              <Link href="/apply-vendor" className="tt-btn text-xs bg-black/60 text-white">
                Start Selling
              </Link>
          ...
          <div className="relative theme-set shadow no-border p-6 overflow-hidden">
            ...
            <p className="opacity-70 text-xs leading-[1.6] mb-2 sm:mb-5 text-[var(--tt-text)]">
            ...
            <div className="flex gap-[0.6rem] flex-wrap">
              <Link href="/near-me" className="tt-btn tt-btn-primary tt-shimmer text-xs">
                Find Nearby Deals
              </Link>
